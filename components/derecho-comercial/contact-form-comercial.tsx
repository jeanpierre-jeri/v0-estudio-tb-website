...
export default function ContactFormComercial() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log("Enviando formulario de Derecho Comercial a admin@estudiotb.com:", formData)
      ...
      alert(
        "Gracias por contactarnos. Su consulta sobre Derecho Comercial ha sido enviada correctamente a admin@estudiotb.com. Nos comunicaremos a la brevedad.",
      )
  ...
  return (
    <section id="contacto-comercial" className="w-full bg-white py-20">
      <div className="container mx-auto px-4">
        <div className="mx-auto max-w-3xl rounded-lg border border-gray-200 bg-white p-8 shadow-md">
          <h2 className="mb-6 text-center font-serif text-2xl font-bold text-navy-blue md:text-3xl">
            Formulario de contacto - Derecho Comercial
          </h2>
          <p className="mb-8 text-center text-gray-600">
            Complete el formulario a continuación para recibir asesoramiento especializado en Derecho Comercial.
          </p>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <div className="space-y-2">
                ...
                <Select value={formData.motivo} onValueChange={handleSelectChange} disabled={isSubmitting}>
                  ...
                  <SelectContent>
                    <SelectItem value="sociedades">Constitución y modificación de sociedades</SelectItem>
                    <SelectItem value="contratos">Contratos comerciales</SelectItem>
                    <SelectItem value="concursos">Concursos y quiebras</SelectItem>
                    <SelectItem value="conflictos">Conflictos societarios</SelectItem>
                    <SelectItem value="otro">Otro tema comercial</SelectItem>
                  </SelectContent>
                </Select>
              </div>
            </div>
