...
export default function HeroLaboral() {
  return (
    <section className="relative w-full bg-navy-blue text-white">
      ...
      <div className="container relative z-10 mx-auto flex min-h-[70vh] flex-col items-center justify-center px-4 py-20 text-center md:min-h-[60vh] lg:min-h-[70vh]">
        ...
        <h1 className="mb-4 font-serif text-4xl font-bold tracking-tight md:text-5xl lg:text-6xl">Derecho Laboral</h1>
        <p className="mb-6 max-w-2xl text-lg font-light md:text-xl lg:text-2xl">
          Protegemos tus derechos en el ámbito del trabajo
        </p>
        <p className="mb-8 max-w-3xl text-base text-gray-200 md:text-lg">
          Ya seas trabajador o empleador, en Estudio TB brindamos representación y asesoramiento legal para resolver
          conflictos laborales de forma rápida y eficaz.
        </p>
        <Button asChild size="lg" className="bg-white text-navy-blue hover:bg-gray-100">
          <Link href="#contacto-laboral">Solicitá asesoramiento laboral</Link>
        </Button>
      </div>
